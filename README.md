...
You can either download the source codes and run the `Main.java`, or download this [TheMadHouse.zip](https://github.com/Trotyl15/TheMadHouse/files/7772449/TheMadHouse.zip), and run the `.jar` file (recommended). You may use your cursor to inspect on objects and `wasd` to move.
